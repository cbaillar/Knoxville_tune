...
#line 1 "STAR_2006_I709170TEST.cc"
// -*- C++ -*-
...
namespace Rivet {
  ...
  class STAR_2006_I709170TEST: public Analysis {
  public:

    /// Constructor
    RIVET_DEFAULT_ANALYSIS_CTOR(STAR_2006_I709170TEST);
  ...
  RIVET_DECLARE_PLUGIN(STAR_2006_I709170TEST);
